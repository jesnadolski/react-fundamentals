...
export default class ClassComponentDemo extends Component{
    ...
    render(){
        ...
        return(
            ...
            <button onClick={this.incrementCount}>Likes: {this.state.count}</button>
            <button onClick={this.decreaseCount}>Dislikes: {this.state.decrease}</button>
            </div>
            </div>
        );
    }
